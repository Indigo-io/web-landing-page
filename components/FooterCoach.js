...
export default function FooterCoachs() {
  return (
    <footer className="footer" role="contentinfo">
      <div className="footer__wrapper">
        ...
        <div className="footer__sections">
          ...
          <a href="#beneficiosCoach" className="footer__links--item">
            Beneficios
          </a>
          <a href="#camino" className="footer__links--item">
            Funcionamiento
          </a>
          <a href="#apps" className="footer__links--item">
            Empeza ya mismo!
          </a>
